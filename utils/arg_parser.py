...
def experts_training_arg_parser():
    ...
    parser.add_argument("--model_name", type=str, default="/home/rajabi/AliEdalat/data/models--microsoft--phi-2/snapshots/ef382358ec9e382308935a992d908de099b64c23")
    ...
    parser.add_argument("--dataset_name", type=str, default="/home/rajabi/modular_llm_project/data/TahaBa___flan-routing-mo_e-dataset/default/0.0.0/9d08cf5fb66bdb9d866fa19a80a41f678b03cb1c")
    parser.add_argument("--project_name", type=str, default='TrainExperts')

    parser.add_argument("--language_expert", type=int, default=False)
    parser.add_argument("--language", type=str, default='en')
    parser.add_argument("--le_train_json_path", type=str, default='.')
    parser.add_argument("--le_test_json_path", type=str, default='.')
